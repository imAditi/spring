...
public interface UserService {
	...
	/**
	 * This method hands the login operation (authentication) using given login name
	 * and password. If user is successfully logged in, this method will return the
	 * logged in user object, otherwise it will return null. When user is blocked,
